...
//				是否使用url连接
		...
		GradientPaint gradientpaint = new GradientPaint(0.0F, 0.0F, Color.red,
				0.0F, 0.0F, Color.black);// 从上到下渐变的颜色
		GradientPaint gradientpaint1 = new GradientPaint(0.0F, 0.0F,
				Color.green, 0.0F, 0.0F, Color.red);// 从上到下渐变的颜色
